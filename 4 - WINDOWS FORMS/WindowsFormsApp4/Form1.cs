...
namespace WindowsFormsApp4
{
    ...
    {
        public static List<Cadastro_de_Produto> testes = new List<Cadastro_de_Produto>();
        ...
        {
            var novo = new Cadastro_de_Produto();
            novo.Nome = txtString.Text;
            novo.Tipo = txtTipo.Text;
        ...
        private void AtualizarLista()
        {
            ...
            {
                dataGridView1.Rows.Add(new object[] { "Clique para Alterar", "Clique para Excluir", i.Id.ToString(), i.DataHora.ToString(), i.Nome, i.Tipo.ToString()});
            }
        }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
           ...
           txtString.Text = row.Cells[5].Value.ToString();
        ...
        private void ddlInteiro_ValueChanged(object sender, EventArgs e)
        {
                    }
